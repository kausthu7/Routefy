    ...
    <div className="p-[20px] md:p-[32px] max-w-7xl mx-auto space-y-[24px] animate-in fade-in duration-500 relative z-10 pb-32">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 px-2">
        <div className="flex items-center gap-4 mt-4 md:mt-0">
          <h1 className="text-3xl md:text-2xl font-bold tracking-tight text-white md:text-slate-900 uppercase">OVERVIEW</h1>
          {!isNewAccount && (
            <div className="text-sm font-medium text-white/70 md:text-slate-500 flex items-center gap-2 cursor-pointer hover:text-white md:hover:text-slate-700 transition-colors">
              Show: <span className="text-white md:text-slate-700">All Shipments</span> <span className="text-xs">▼</span>
            </div>
          )}
        </div>
        <div className="flex flex-wrap items-center gap-4">
          {!isNewAccount && (
            <button className="bg-brand-accent hover:bg-[#F0D050] text-brand-dark text-sm font-bold py-2.5 px-6 rounded-xl shadow-md transition-all flex items-center gap-2">
      ...
      {/* AI Assistant Banner */}
      <div className="w-full md:max-w-none mx-auto p-[28px] md:p-[32px] bg-white/95 backdrop-blur-xl rounded-[32px] flex flex-col shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-white/40 hover:scale-[1.02] transition-all duration-300 relative overflow-hidden group">
        <div className="relative z-10 mb-6">
          <div className="flex items-center gap-3 mb-2">
            <IconBadge icon={Sparkles} variant="purple" />
            <span className="text-xl font-bold text-slate-800 uppercase">AI ASSISTANT</span>
          </div>
          <p className="text-[14px] font-medium text-slate-500 mb-4">Ready to create your next shipment.</p>
          <div className="flex flex-wrap gap-2 text-[12px] text-slate-500 font-semibold">
            <span className="bg-slate-100 px-3 py-1.5 rounded-lg border border-slate-200/50 text-slate-600">Paste text</span>
            <span className="bg-slate-100 px-3 py-1.5 rounded-lg border border-slate-200/50 text-slate-600">Upload Screenshot</span>
            <span className="bg-slate-100 px-3 py-1.5 rounded-lg border border-slate-200/50 text-slate-600">Voice</span>
          </div>
        </div>
        <Link href="/dashboard/ai-order" className="relative z-10 w-full h-[52px] bg-[#F9DF77] hover:bg-[#F0D050] rounded-[16px] text-[#14152e] flex items-center justify-center font-bold shadow-[0_8px_20px_rgba(249,223,119,0.4)] transition-all text-[15px]">
          + New Shipment
        </Link>
      </div>

      {/* Premium Light Metric Cards - 2x2 Grid on mobile */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-[12px] md:gap-[24px] relative w-full max-w-none mx-auto pb-4">
        {/* Orders Card */}
        <div className="w-full bg-[#E8E9F6] md:bg-white/95 backdrop-blur-xl rounded-[20px] md:rounded-[24px] p-[16px] md:p-[20px] flex flex-col justify-between min-h-[130px] md:min-h-[160px] group overflow-hidden relative shadow-md border border-white/40 md:border-slate-100 hover:scale-[1.02] transition-all duration-300">
          <div className="absolute top-0 right-0 w-32 h-32 bg-brand-main/10 rounded-full blur-3xl -mr-10 -mt-10 transition-transform duration-700 group-hover:scale-150" />
          ...
          <div className="mt-auto relative z-10">
            <div className="flex items-baseline gap-3 mb-1">
              <div className="text-2xl md:text-3xl font-[600] tabular-nums tracking-tight text-brand-dark leading-none">{totalOrders}</div>
            </div>
            <p className="text-[12px] text-emerald-600 font-[600] flex items-center gap-1.5 mt-2">
              +{ordersToday}% Today
            </p>
          </div>
        </div>
        ...
        <div className="w-full bg-[#E8E9F6] md:bg-white/95 backdrop-blur-xl rounded-[20px] md:rounded-[24px] p-[16px] md:p-[20px] flex flex-col justify-between min-h-[130px] md:min-h-[160px] group overflow-hidden relative shadow-md border border-white/40 md:border-slate-100 hover:scale-[1.02] transition-all duration-300">
          <div className="absolute top-0 right-0 w-32 h-32 bg-brand-main/10 rounded-full blur-3xl -mr-10 -mt-10 transition-transform duration-700 group-hover:scale-150" />
          <div className="flex items-center gap-3 mb-3 relative z-10">
            <IconBadge icon={Wallet} variant="purple" />
            <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Wallet</span>
          </div>
          <div className="mt-auto relative z-10">
            <div className="flex items-baseline gap-2 mb-1">
              <div className="text-2xl md:text-3xl font-[600] tabular-nums tracking-tight text-brand-dark leading-none">₹{formattedBalance}</div>
            </div>
            <p className="text-[12px] text-emerald-600 font-[600] flex items-center gap-1.5 mt-2">
              +₹0 Today
            </p>
        ...
        <div className="w-full bg-[#E8E9F6] md:bg-white/95 backdrop-blur-xl rounded-[20px] md:rounded-[24px] p-[16px] md:p-[20px] flex flex-col justify-between min-h-[130px] md:min-h-[160px] group overflow-hidden relative shadow-md border border-white/40 md:border-slate-100 hover:scale-[1.02] transition-all duration-300">
          <div className="absolute top-0 right-0 w-32 h-32 bg-brand-main/10 rounded-full blur-3xl -mr-10 -mt-10 transition-transform duration-700 group-hover:scale-150" />
          <div className="flex items-center gap-3 mb-3 relative z-10">
            <IconBadge icon={Truck} variant="purple" />
            <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Shipping</span>
          </div>
          <div className="mt-auto relative z-10">
            <div className="flex items-baseline gap-3 mb-1">
              <div className="text-2xl md:text-3xl font-[600] tabular-nums tracking-tight text-brand-dark leading-none">₹{formattedSpent}</div>
            </div>
            <p className="text-[12px] text-slate-500 font-[600] mt-2">
              Lifetime
            </p>
          </div>
        </div>
        ...
        <div className="w-full bg-[#E8E9F6] md:bg-white/95 backdrop-blur-xl rounded-[20px] md:rounded-[24px] p-[16px] md:p-[20px] flex flex-col justify-between min-h-[130px] md:min-h-[160px] group overflow-hidden relative shadow-md border border-white/40 md:border-slate-100 hover:scale-[1.02] transition-all duration-300">
          <div className="absolute top-0 right-0 w-32 h-32 bg-brand-main/10 rounded-full blur-3xl -mr-10 -mt-10 transition-transform duration-700 group-hover:scale-150" />
          <div className="flex items-center gap-3 mb-3 relative z-10">
            <IconBadge icon={Undo2} variant="purple" />
            <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Returns</span>
          </div>
          <div className="mt-auto relative z-10">
            <div className="flex items-baseline gap-3 mb-1">
              <div className="text-2xl md:text-3xl font-[600] tabular-nums tracking-tight text-brand-dark leading-none">₹0</div>
            </div>
            <p className="text-[12px] text-slate-500 font-[600] mt-2">
              No returns
            </p>
      ...
      <div className="flex flex-col xl:flex-row gap-[24px] xl:gap-6 mt-[24px] w-full max-w-[353px] md:max-w-none mx-auto">
        ...
        <div className="bg-white rounded-[22px] p-[22px] flex-1 min-h-[340px] md:min-h-[400px] flex flex-col shadow-sm border border-slate-100">
          <div className="flex items-center justify-between mb-[24px]">
            <h3 className="text-[18px] md:text-[22px] font-[700] text-slate-900 uppercase">SHIPPING VOLUME</h3>
        ...
        <div className="bg-white/92 backdrop-blur-xl rounded-[24px] p-[24px] w-full xl:w-[353px] min-h-[340px] md:min-h-[400px] flex flex-col shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-slate-100 hover:scale-[1.02] transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
             <h3 className="text-[18px] md:text-[22px] font-[700] text-slate-900 uppercase">RECENT</h3>
          </div>
          <div className="flex-1 flex flex-col items-center justify-center text-center p-4">
             {orders.length === 0 ? (
               <>
                 ...
                 <h4 className="text-[20px] font-[700] text-slate-900 leading-tight mb-2 uppercase">NO SHIPMENTS YET</h4>
